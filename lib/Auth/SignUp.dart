...
class _SignUpState extends State<SignUp> {
  ...
  Future<Object> fetchResponse(String phoneNumber) async {
    final url =
        'https://maapitambrapvtitijhansi.com/app/api/signedUp?phone=$signup_phone';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (response.body == "false") {
          ...
          setState(() {
            loading = false; // Stop the progress indicator
          });
  ...
  Future<Object> fetchResponse2() async {
    final url = 'https://maapitambrapvtitijhansi.com/app/api/count';
    String CountUser = '';
    try {
      final response = await http.get(Uri.parse(url));
  ...
  Future<void> signUp() async {
    ...
    String apiUrl = 'https://maapitambrapvtitijhansi.com/app/api/signup';
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                const Text(
                  'Welcome to Maa Pitambra PVT ITI, Jhansi',
                  style: TextStyle(
                      fontSize: 18,
